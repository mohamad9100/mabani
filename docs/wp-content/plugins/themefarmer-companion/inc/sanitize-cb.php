 ...
 */
function themefarmer_companion_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function themefarmer_companion_sanitize_css( $css ) {
 ...
 */
function themefarmer_companion_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function themefarmer_companion_sanitize_email( $email, $setting ) {
 ...
 */
function themefarmer_companion_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function themefarmer_companion_sanitize_html( $html ) {
 ...
 */
function themefarmer_companion_sanitize_image( $image, $setting ) {
 ...
 */
function themefarmer_companion_sanitize_nohtml( $nohtml ) {
 ...
 */
function themefarmer_companion_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function themefarmer_companion_sanitize_number_range( $number, $setting ) {
 ...
 */
function themefarmer_companion_sanitize_select( $input, $setting ) {
 ...
 */
function themefarmer_companion_sanitize_url( $url ) {
