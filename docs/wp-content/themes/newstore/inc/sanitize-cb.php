 ...
 */
function newstore_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function newstore_sanitize_css( $css ) {
 ...
 */
function newstore_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function newstore_sanitize_email( $email, $setting ) {
 ...
 */
function newstore_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function newstore_sanitize_html( $html ) {
 ...
 */
function newstore_sanitize_image( $image, $setting ) {
 ...
 */
function newstore_sanitize_nohtml( $nohtml ) {
 ...
 */
function newstore_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function newstore_sanitize_number_range( $number, $setting ) {
 ...
 */
function newstore_sanitize_select( $input, $setting ) {
 ...
 */
function newstore_sanitize_url( $url ) {
